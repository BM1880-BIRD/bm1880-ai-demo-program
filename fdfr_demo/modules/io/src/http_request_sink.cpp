...
bool http_post_content(const std::string &host_addr, int port, const std::string &url, const std::string &mimetype, const Memory::SharedView<unsigned char> &data) {
...
static size_t content_length(const std::vector<std::tuple<std::string, std::string, Memory::SharedView<unsigned char>>> &data) {
